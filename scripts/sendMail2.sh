...
END { print "</TABLE></BODY></HTML></\BR></\BR>" }' $SPOOLPATH/fetchRequestDetails.csv >> $SPOOLPATH/fetchRequestDetails.html
...
END { print "</TABLE></BODY></HTML>" }' $SPOOLPATH/fetchLogsDetails.csv >> $SPOOLPATH/fetchRequestDetails.html


echo  "<BR>Thanks,</\BR> <BR>DataAttribution</\BR>" >> $SPOOLPATH/fetchRequestDetails.html

(
echo "From: AttributionAlerts@zds-db3-02.bo3.e-dialog.com "
echo "To: $ALERT_TO "
echo "MIME-Version: 1.0"
echo "Subject: APT REQUEST DETAILS :: $CLIENT_NAME "
